      ...
      <div class="row">
        ...
        <div class="col-xl-7 p-0">
          <div class="login-card">
            <div>
              <div><a class="logo" href="{{ route('login') }}"><img class="img-fluid for-light" src="{{ asset('templates/backend/CubeTheme') }}/images/logo/login.png" alt="looginpage"><img class="img-fluid for-dark" src="{{ asset('templates/backend/CubeTheme') }}/images/logo/logo_dark.png" alt="looginpage"></a></div>
